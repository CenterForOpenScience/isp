...
input("Please put your mouse over the top box, near the middle if possible, then return.")
...
for position in positions:
    offset = (- center_position[0] + position[0], - center_position[1] + position[1])
    offsets.append(offset)

for cardset in range(30):  # cardset is just the next 3 cards, eg, each category gets a card, then do the next set, for 90 in total.
