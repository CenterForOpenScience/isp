const translations = {
    ...
    "consent": {
        ...
        "firstSection": "consent.firstSection",
        "secondSection": "consent.secondSection",
        "thirdSection": "consent.thirdSection",
        "title": "consent.title"
    },
    "feedback": {
        "firstSection": "feedback.firstSection",
        "hiAgree": "feedback.hiAgree",
        "hiConsc": "feedback.hiConsc",
        "hiExtra": "feedback.hiExtra",
        "hiNeurot": "feedback.hiNeurot",
        "hiOpen": "feedback.hiOpen",
        "loAgree": "feedback.loAgree",
        "loConsc": "feedback.loConsc",
        "loExtra": "feedback.loExtra",
        "loNeurot": "feedback.loNeurot",
        "loOpen": "feedback.loOpen",
        "secondSection": "feedback.secondSection",
        "thirdSection": "feedback.thirdSection",
        "title": "feedback.title"
    },
    "global": {
        "aGreatDeal": "global.aGreatDeal",
        "agreement": {
            "agree": "global.agreement.agree",
            "agreeStrong": "global.agreement.agreeStrong",
            "dis": "global.agreement.dis",
            "disStrong": "global.agreement.disStrong",
            "neutral": "global.agreement.neutral"
        },
        "believe": {
            "believeLittle": "global.believe.believeLittle",
            "believeStrong": "global.believe.believeStrong",
            "disbelieveLittle": "global.believe.disbelieveLittle",
            "disbelieveStrong": "global.believe.disbelieveStrong",
            "neutral": "global.believe.neutral"
        },
        "char": {
            "extremelyChar": "global.char.extremelyChar",
            "extremelyUnchar": "global.char.extremelyUnchar",
            "fairlyChar": "global.char.fairlyChar",
            "fairlyUnchar": "global.char.fairlyUnchar",
            "neutral": "global.char.neutral",
            "quiteChar": "global.char.quiteChar",
            "quiteUnchar": "global.char.quiteUnchar",
            "somewhatChar": "global.char.somewhatChar",
            "somewhatUnchar": "global.char.somewhatUnchar"
        },
        "continueLabel": "global.continueLabel",
        "describe": {
            "aLittle": "global.describe.aLittle",
            "exactly": "global.describe.exactly",
            "moderately": "global.describe.moderately",
            "notAtAll": "global.describe.notAtAll",
            "veryWell": "global.describe.veryWell"
        },
        "noLabel": "global.noLabel",
        "notAtAll": "global.notAtAll",
        "selectUnselected": "global.selectUnselected",
        "yesLabel": "global.yesLabel"
    },
    "measures": {
        "questions": {
            "1": {
        ...
        "scale": {
            "Disagreee": "measures.scale.Disagreee",
            "DisagreeeStrongly": "measures.scale.DisagreeeStrongly",
            "agree": "measures.scale.agree",
            "agreeStrongly": "measures.scale.agreeStrongly",
            "neutral": "measures.scale.neutral"
        }
    },
    "number0": "number0",
    "number1": "number1",
    ...
    "qsort": {
        ...
        "sections": {
            "1": {
                "categories": {
                    "characteristic": "qsort.sections.1.categories.characteristic",
            ...
            "2": {
                "categories": {
                    "extremelyChar": "qsort.sections.2.categories.extremelyChar",
                    "extremelyUnchar": "qsort.sections.2.categories.extremelyUnchar",
                    "fairlyChar": "qsort.sections.2.categories.fairlyChar",
                    "fairlyUnchar": "qsort.sections.2.categories.fairlyUnchar",
                    "neutral": "qsort.sections.2.categories.neutral",
                    "quiteChar": "qsort.sections.2.categories.quiteChar",
                    "quiteUnchar": "qsort.sections.2.categories.quiteUnchar",
    ...
    "survey": {
        "sections": {
            "1": {
                ...
                "questions": {
                    "1": {
                        "label": "survey.sections.1.questions.1.label"
                    },
                    "10": {
                        "label": "survey.sections.1.questions.10.label"
                    },
                    "2": {
                        "label": "survey.sections.1.questions.2.label",
                        "options": {
                    ...
                    "3": {
                        "label": "survey.sections.1.questions.3.label"
                    },
                    "4": {
                        "label": "survey.sections.1.questions.4.label"
                    },
                    "5": {
                        "label": "survey.sections.1.questions.5.label"
                    },
                    "6": {
                        "label": "survey.sections.1.questions.6.label"
                    },
                    "7": {
                        "label": "survey.sections.1.questions.7.label",
                        "options": {
                            "remoteRural": "survey.sections.1.questions.7.options.remoteRural",
                            "rural": "survey.sections.1.questions.7.options.rural",
                            "suburban": "survey.sections.1.questions.7.options.suburban",
                            "urban": "survey.sections.1.questions.7.options.urban"
                        },
                        "selectUnselected": "survey.sections.1.questions.7.selectUnselected"
                    },
                    "8": {
                        "label": "survey.sections.1.questions.8.label",
                        "noLabel": "survey.sections.1.questions.8.noLabel",
                        "yesLabel": "survey.sections.1.questions.8.yesLabel"
                    },
                    "9": {
                        "label": "survey.sections.1.questions.9.label"
                    }
                }
            },
            "2": {
                ...
                "questions": {
                    "11": {
                        "characterCount": "survey.sections.2.questions.11.characterCount",
                        "label": "survey.sections.2.questions.11.label"
                    },
                    "12": {
                        "characterCount": "survey.sections.2.questions.12.characterCount",
                        "label": "survey.sections.2.questions.12.label"
                    },
                    "13": {
                        "characterCount": "survey.sections.2.questions.13.characterCount",
    ...
    "thankyou": {
        "exitButton": "thankyou.exitButton",
        "instructions": "thankyou.instructions",
        "personalityFeedbackButton": "thankyou.personalityFeedbackButton",
